                    ...
                    <div className="xl:pl-20 pl-9 relative mb-5">
                        <div className=''>
                            <div className="absolute left-[-1rem] xl:left-6 top-[1.2rem]">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-mortarboard-fill text-secondary drop-shadow-lg" viewBox="0 0 16 16">
                    ...
                    <div className="xl:pl-20 pl-9 relative mb-5">
                        <div className=''>
                            <div className="absolute left-[-0.8rem] xl:left-[1.69rem] top-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-briefcase-fill text-secondary drop-shadow-lg" viewBox="0 0 16 16">
